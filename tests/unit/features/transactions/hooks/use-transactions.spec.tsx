...
describe('useTransactions', () => {
  ...
  it('should return loading state when data is loading', () => {
    const mockUseFetchTransactions = useFetchTransactions as vi.MockedFunction<
      typeof useFetchTransactions
    >;
    const mockUseFetchPaymentMethods =
      useFetchPaymentMethods as vi.MockedFunction<
        typeof useFetchPaymentMethods
      >;
    const mockUseFetchCards = useFetchCards as vi.MockedFunction<
      typeof useFetchCards
    >;
