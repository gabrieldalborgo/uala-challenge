...
describe('cn utility function', () => {
  ...
  it('should handle arrays of classes', () => {
    const result = cn(['px-2', 'py-1'], 'bg-red-500', ['text-white', 'font-bold'])
  ...
  it('should handle mixed input types', () => {
    ...
    expect(result).toBe('base-class visible-class array-class-1 array-class-2 object-class string-class')
  })
})
