  ...
  test.describe('Loading state', () => {
    ...
    test.describe('Desktop View', () => {
      ...
      test('page layout should be consistent', async ({ page }) => {
        ...
        // Take screenshot of the entire page
        await expect(page).toHaveScreenshot('home-page-loading-layout-desktop.png')
      })
    })
    ...
    test.describe('Responsive Behavior', () => {
      test('page should adapt to different screen sizes', async ({ page }) => {
        ...
        await expect(page).toHaveScreenshot('home-page-loading-responsive-desktop.png')
        
        // Test mobile view
        await page.setViewportSize({ width: 375, height: 667 })
        await expect(page).toHaveScreenshot('home-page-loading-responsive-mobile.png')
      })
    })
    ...
    test.describe('Cross-Browser Compatibility', () => {
      test('page should look consistent across browsers', async ({ page }) => {
        ...
        await expect(page).toHaveScreenshot('home-page-loading-cross-browser.png')
      })
    })
    ...
    test.describe('Performance', () => {
      test('page should render quickly', async ({ page }) => {
        ...
        await expect(page).toHaveScreenshot('home-page-loading-performance.png')
      })
    })
  })
  ...
  test.describe('Error state', () => {
    ...
    test.describe('Desktop View', () => {
      ...
      test('page layout should be consistent', async ({ page }) => {
        ...
        // Take screenshot of the entire page
        await expect(page).toHaveScreenshot('home-page-error-layout-desktop.png')
      })
    })
    ...
    test.describe('Responsive Behavior', () => {
      test('page should adapt to different screen sizes', async ({ page }) => {
        // Test desktop view
        await page.setViewportSize({ width: 1280, height: 720 })
        await expect(page).toHaveScreenshot('home-page-error-responsive-desktop.png')
        
        // Test mobile view
        await page.setViewportSize({ width: 375, height: 667 })
        await expect(page).toHaveScreenshot('home-page-error-responsive-mobile.png')
      })
    })
    ...
    test.describe('Cross-Browser Compatibility', () => {
      test('page should look consistent across browsers', async ({ page }) => {
        // This test will run in different browsers based on the project configuration
        await expect(page).toHaveScreenshot('home-page-error-cross-browser.png')
      })
    })
