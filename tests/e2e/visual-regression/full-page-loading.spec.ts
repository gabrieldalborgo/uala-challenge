...
test.describe('Full Page Loading Visual Regression Tests', () => {
  ...
  test.describe('Desktop View', () => {
    ...
    test('full page should match design', async ({ page }) => {
      ...
      await expect(page).toHaveScreenshot('full-page-loading-desktop.png')
    })
    ...
    test('page layout should be consistent', async ({ page }) => {
      ...
      // Take screenshot of the entire page
      await expect(page).toHaveScreenshot('full-page-loading-layout-desktop.png')
    })
  })
  ...
  test.describe('Mobile View', () => {
    ...
    test('full page should match mobile design', async ({ page }) => {
      // Take screenshot of the entire page
      await expect(page).toHaveScreenshot('full-page-loading-mobile.png')
    })
  })
  ...
  test.describe('Responsive Behavior', () => {
    test('page should adapt to different screen sizes', async ({ page }) => {
      ...
      await expect(page).toHaveScreenshot('full-page-loading-responsive-desktop.png')
      
      // Test mobile view
      await page.setViewportSize({ width: 375, height: 667 })
      await expect(page).toHaveScreenshot('full-page-loading-responsive-mobile.png')
    })
  })
  ...
  test.describe('Cross-Browser Compatibility', () => {
    test('page should look consistent across browsers', async ({ page }) => {
      ...
      await expect(page).toHaveScreenshot('full-page-loading-cross-browser.png')
    })
  })
  ...
  test.describe('Performance', () => {
    test('page should render quickly', async ({ page }) => {
      ...
      await expect(page).toHaveScreenshot('full-page-loading-performance.png')
    })
  })
})
