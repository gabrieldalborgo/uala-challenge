    ...
    <div className="flex flex-col h-full m-5 mb-0">
      ...
      <div className="flex items-center">
        <div className="flex items-center gap-3">
          ...
          <h1
            className="text-[16px] font-semibold leading-[18px] text-[#3A3A3A]"
            style={{ fontFamily: 'Public Sans', letterSpacing: '0px' }}
          >
            Filtros
          </h1>
        </div>
      ...
      <div className="flex-1 overflow-y-auto mt-10">
        ...
        <div className="p-2 mb-2">
          ...
          <InstallmentFilter
            ...
            onChange={(value: Filters['installment']) =>
              handleFilterChange('installment', value)
            }
          />
          ...
          <PaymentMethodFilter
            ...
            onChange={(value: Filters['paymentMethod']) =>
